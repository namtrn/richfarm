...
export default defineSchema({
  ...
  plantsMaster: defineTable({
    ...
    .searchIndex("search_common_names", {
      searchField: "commonNames",
      filterFields: ["group", "purposes"],
    }),
  ...
  logs: defineTable({
    ...
    value: v.optional(v.record(v.any())), // Flexible data: { amountMl: 500, fertilizerType: "organic" }
  ...
  plantGroups: defineTable({
    ...
    displayName: v.record(v.string()), // { vi: "Rau thơm", en: "Herbs" }
    description: v.optional(v.record(v.string())),
  ...
  aiAnalysisQueue: defineTable({
    ...
    // Result
    result: v.optional(v.record(v.any())),
...
export type User = typeof schema.users.validator;
export type PlantsMaster = typeof schema.plantsMaster.validator;
export type Bed = typeof schema.beds.validator;
export type UserPlant = typeof schema.userPlants.validator;
export type PlantPhoto = typeof schema.plantPhotos.validator;
export type Reminder = typeof schema.reminders.validator;
export type Log = typeof schema.logs.validator;
export type HarvestRecord = typeof schema.harvestRecords.validator;
export type PlantGroup = typeof schema.plantGroups.validator;
export type PreservationRecipe = typeof schema.preservationRecipes.validator;
export type DeviceToken = typeof schema.deviceTokens.validator;
export type AiAnalysisQueue = typeof schema.aiAnalysisQueue.validator;
export type UserSettings = typeof schema.userSettings.validator;
