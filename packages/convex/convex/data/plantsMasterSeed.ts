...
const supplementalPlantCatalogSeed: SupplementalPlantCatalogEntry[] = [
    ...
    { scientificName: "Brassica rapa", group: "leafy_greens", enCommonName: "Field Mustard", viCommonName: "Cai dau", purposes: ["cooking"], cultivars: [], typicalDaysToHarvest: 45, germinationDays: 5, lightRequirements: "full_sun", spacingCm: 20, wateringFrequencyDays: 2, fertilizingFrequencyDays: 14 },
    { scientificName: "Brassica oleracea", group: "leafy_greens", enCommonName: "Wild Cabbage", viCommonName: "Cai bap dai", purposes: ["cooking"], cultivars: [], typicalDaysToHarvest: 70, germinationDays: 5, lightRequirements: "full_sun", spacingCm: 40, wateringFrequencyDays: 2, fertilizingFrequencyDays: 14 },
    { scientificName: "Brassica napus", group: "roots", enCommonName: "Rapeseed", viCommonName: "Cai dau dau", purposes: ["cooking"], cultivars: [], typicalDaysToHarvest: 90, germinationDays: 5, lightRequirements: "full_sun", spacingCm: 25, wateringFrequencyDays: 2, fertilizingFrequencyDays: 14 },
...
const expandedSupplementalPlantCatalogSeed: SupplementalPlantCatalogEntry[] = [
    ...
    makeSupplementalCatalogEntry({ scientificName: "Borago officinalis", group: "herbs", enCommonName: "Borage", viCommonName: "Hoa luu ly an duoc", cultivars: ["Common Blue", "Alba", "Variegata", "Blue Star", "Compact"] }),
    makeSupplementalCatalogEntry({ scientificName: "Satureja hortensis", group: "herbs", enCommonName: "Summer Savory", viCommonName: "Huong dau mua he", cultivars: ["Aromata", "Saturn", "Compacta", "Dwarf Green", "Fine Leaf"] }),
    makeSupplementalCatalogEntry({ scientificName: "Levisticum officinale", group: "herbs", enCommonName: "Lovage", viCommonName: "Ngo nui", cultivars: ["Common", "Verino", "Maggi", "Giant Leaf", "Dark Stem"] }),
    makeSupplementalCatalogEntry({ scientificName: "Myrrhis odorata", group: "herbs", enCommonName: "Sweet Cicely", viCommonName: "Ngo ngot chau Au", cultivars: ["Common", "British Sweet", "Aromatic", "Green Lace", "Mountain Sweet"] }),
    makeSupplementalCatalogEntry({ scientificName: "Tanacetum balsamita", group: "herbs", enCommonName: "Costmary", viCommonName: "La thom costmary", cultivars: ["Bible Leaf", "Mint Geranium", "Common", "Aureum", "Sweet Leaf"] }),
    makeSupplementalCatalogEntry({ scientificName: "Allium ursinum", group: "alliums", enCommonName: "Wild Garlic", viCommonName: "Toi rung", cultivars: ["Broadleaf", "Wildwood", "Forest Green", "Alba", "Early Spring"] }),
    makeSupplementalCatalogEntry({ scientificName: "Beta vulgaris subsp. vulgaris", group: "leafy_greens", enCommonName: "Swiss Chard", viCommonName: "Cai cau vong", cultivars: ["Bright Lights", "Fordhook Giant", "Rhubarb", "Lucullus", "Perpetual Spinach"] }),
    makeSupplementalCatalogEntry({ scientificName: "Lepidium sativum", group: "leafy_greens", enCommonName: "Garden Cress", viCommonName: "Cai xoong can", cultivars: ["Curled", "Persian", "Sprint", "Extra Curled", "Broadleaf"] }),
    makeSupplementalCatalogEntry({ scientificName: "Nasturtium officinale", group: "leafy_greens", enCommonName: "Watercress", viCommonName: "Xa lach xoong", cultivars: ["Aqua", "Broadleaf", "English", "Cressida", "Dark Green"] }),
    makeSupplementalCatalogEntry({ scientificName: "Tetragonia tetragonioides", group: "leafy_greens", enCommonName: "New Zealand Spinach", viCommonName: "Rau bina New Zealand", cultivars: ["Maori", "Warrigal", "Green Wave", "Summer Green", "Coastal"] }),
    makeSupplementalCatalogEntry({ scientificName: "Portulaca oleracea", group: "leafy_greens", enCommonName: "Purslane", viCommonName: "Rau sam", cultivars: ["Golden", "Green", "Tall Green", "Red Gruner", "Gruner Red"] }),
    makeSupplementalCatalogEntry({ scientificName: "Taraxacum officinale", group: "leafy_greens", enCommonName: "Dandelion Greens", viCommonName: "La bo cong anh", cultivars: ["Catalogna", "Ameliore", "Vert de Montmagny", "Thick Leaf", "Clio"] }),
    makeSupplementalCatalogEntry({ scientificName: "Crambe maritima", group: "leafy_greens", enCommonName: "Sea Kale", viCommonName: "Cai bien", cultivars: ["Lily White", "Ivory", "Angers", "Common", "Sea Spray"] }),
    makeSupplementalCatalogEntry({ scientificName: "Brassica oleracea var. gemmifera", group: "vegetables", enCommonName: "Brussels Sprouts", viCommonName: "Bap cai ti hon", cultivars: ["Long Island Improved", "Jade Cross", "Diablo", "Churchill", "Red Bull"] }),
    makeSupplementalCatalogEntry({ scientificName: "Brassica oleracea var. gongylodes", group: "roots", enCommonName: "Kohlrabi", viCommonName: "Su hao", cultivars: ["White Vienna", "Purple Vienna", "Kossak", "Kolibri", "Gigante"] }),
    makeSupplementalCatalogEntry({ scientificName: "Armoracia rusticana", group: "roots", enCommonName: "Horseradish", viCommonName: "Cai ngua", cultivars: ["Maliner Kren", "Big Top", "Bohemian", "Sass", "Variegata"] }),
    makeSupplementalCatalogEntry({ scientificName: "Helianthus tuberosus", group: "roots", enCommonName: "Jerusalem Artichoke", viCommonName: "Atiso dat", cultivars: ["Stampede", "Fuseau", "Red Fuseau", "White Fuseau", "Dwarf Sunray"] }),
    makeSupplementalCatalogEntry({ scientificName: "Scorzonera hispanica", group: "roots", enCommonName: "Black Salsify", viCommonName: "Re scorzonera", cultivars: ["Duplex", "Hoffmanns", "Russian Giant", "Black Peter", "Long Black"] }),
    makeSupplementalCatalogEntry({ scientificName: "Tragopogon porrifolius", group: "roots", enCommonName: "Salsify", viCommonName: "Re hau", cultivars: ["Mammoth Sandwich Island", "White French", "Fiore Blu", "Giant White", "Sandwich"] }),
    makeSupplementalCatalogEntry({ scientificName: "Rheum rhabarbarum", group: "vegetables", enCommonName: "Rhubarb", viCommonName: "Dai hoang an than", cultivars: ["Victoria", "Crimson Cherry", "Timperley Early", "Glaskins Perpetual", "Canada Red"] }),
    makeSupplementalCatalogEntry({ scientificName: "Cucurbita maxima", group: "vegetables", enCommonName: "Winter Squash", viCommonName: "Bi mua dong", cultivars: ["Kabocha", "Hubbard", "Buttercup", "Red Kuri", "Queensland Blue"] }),
    makeSupplementalCatalogEntry({ scientificName: "Cucurbita argyrosperma", group: "vegetables", enCommonName: "Cushaw Squash", viCommonName: "Bi cushaw", cultivars: ["Green Striped Cushaw", "White Cushaw", "Tennessee Sweet Potato", "Japanese Pie", "Silver Seed"] }),
    makeSupplementalCatalogEntry({ scientificName: "Cucurbita ficifolia", group: "vegetables", enCommonName: "Figleaf Gourd", viCommonName: "Bi la sung", cultivars: ["Chilacayote", "Asian White", "Black Seed", "Green Stripe", "Mountain"] }),
    makeSupplementalCatalogEntry({ scientificName: "Cynara cardunculus", group: "vegetables", enCommonName: "Cardoon", viCommonName: "Atiso than", cultivars: ["Gobbo di Nizza", "Porto Spineless", "Large Smooth", "Bianco Avorio", "Gigante"] }),
    makeSupplementalCatalogEntry({ scientificName: "Lupinus albus", group: "legumes", enCommonName: "White Lupin", viCommonName: "Dau lupin trang", cultivars: ["Dieta", "Lublanc", "Multolupa", "Amiga", "Boros"] }),
    makeSupplementalCatalogEntry({ scientificName: "Lathyrus oleraceus", group: "legumes", enCommonName: "Shelling Pea", viCommonName: "Dau Ha Lan lay hat", cultivars: ["Green Arrow", "Alderman", "Lincoln", "Maestro", "Wando"] }),
    makeSupplementalCatalogEntry({ scientificName: "Vigna angularis", group: "legumes", enCommonName: "Adzuki Bean", viCommonName: "Dau do adzuki", cultivars: ["Erimo", "Takara", "Hokkaido", "Dainagon", "Red Chimes"] }),
    makeSupplementalCatalogEntry({ scientificName: "Prunus avium", group: "fruits", enCommonName: "Sweet Cherry", viCommonName: "Anh dao ngot", cultivars: ["Bing", "Rainier", "Stella", "Lapins", "Sweetheart"] }),
    makeSupplementalCatalogEntry({ scientificName: "Prunus cerasus", group: "fruits", enCommonName: "Sour Cherry", viCommonName: "Anh dao chua", cultivars: ["Montmorency", "Morello", "North Star", "Meteor", "English Morello"] }),
    makeSupplementalCatalogEntry({ scientificName: "Prunus domestica", group: "fruits", enCommonName: "Plum", viCommonName: "Man tay", cultivars: ["Stanley", "Victoria", "Damson", "Italian Prune", "President"] }),
    makeSupplementalCatalogEntry({ scientificName: "Prunus armeniaca", group: "fruits", enCommonName: "Apricot", viCommonName: "Mo tay", cultivars: ["Blenheim", "Moorpark", "Tilton", "Goldcot", "Tomcot"] }),
    makeSupplementalCatalogEntry({ scientificName: "Ribes rubrum", group: "fruits", enCommonName: "Redcurrant", viCommonName: "Ly chua do", cultivars: ["Rovada", "Red Lake", "Jonkheer van Tets", "Wilder", "Detvan"] }),
    makeSupplementalCatalogEntry({ scientificName: "Ribes nigrum", group: "fruits", enCommonName: "Blackcurrant", viCommonName: "Ly chua den", cultivars: ["Ben Sarek", "Ben Lomond", "Titania", "Consort", "Blackdown"] }),
    makeSupplementalCatalogEntry({ scientificName: "Ribes uva-crispa", group: "fruits", enCommonName: "Gooseberry", viCommonName: "Ly gai", cultivars: ["Invicta", "Hinnonmaki Red", "Pixwell", "Captivator", "Whinham"] }),
    makeSupplementalCatalogEntry({ scientificName: "Actinidia deliciosa", group: "fruits", enCommonName: "Kiwifruit", viCommonName: "Kiwi", cultivars: ["Hayward", "Bruno", "Monty", "Abbott", "Blake"] }),
    makeSupplementalCatalogEntry({ scientificName: "Actinidia arguta", group: "fruits", enCommonName: "Hardy Kiwi", viCommonName: "Kiwi nho", cultivars: ["Issai", "Ananasnaya", "Geneva", "Ken's Red", "Weiki"] }),
    makeSupplementalCatalogEntry({ scientificName: "Acca sellowiana", group: "fruits", enCommonName: "Feijoa", viCommonName: "Oi dua", cultivars: ["Unique", "Mammoth", "Apollo", "Kaiteri", "Anatoki"] }),
    makeSupplementalCatalogEntry({ scientificName: "Macadamia integrifolia", group: "fruits", enCommonName: "Macadamia", viCommonName: "Mac ca", cultivars: ["Beaumont", "A4", "H2", "Kau", "Mauka"] }),
    makeSupplementalCatalogEntry({ scientificName: "Citrus reticulata", group: "fruits", enCommonName: "Mandarin", viCommonName: "Quyt", cultivars: ["Satsuma", "Clementine", "Tango", "Honey Murcott", "Kishu"] }),
    makeSupplementalCatalogEntry({ scientificName: "Citrus paradisi", group: "fruits", enCommonName: "Grapefruit", viCommonName: "Buoi chum", cultivars: ["Ruby Red", "Marsh", "Oro Blanco", "Rio Red", "Star Ruby"] }),
    makeSupplementalCatalogEntry({ scientificName: "Citrus aurantiifolia", group: "fruits", enCommonName: "Key Lime", viCommonName: "Chanh xanh", cultivars: ["Mexican", "Thornless", "Kagzi", "West Indian", "Bearss"] }),
    makeSupplementalCatalogEntry({ scientificName: "Citrus australasica", group: "fruits", enCommonName: "Finger Lime", viCommonName: "Chanh ngon tay", cultivars: ["Rainforest Pearl", "Pink Ice", "Red Champagne", "Judy's Everbearing", "Emerald"] }),
    makeSupplementalCatalogEntry({ scientificName: "Eriobotrya japonica", group: "fruits", enCommonName: "Loquat", viCommonName: "Ti ba", cultivars: ["Big Jim", "Champagne", "Gold Nugget", "Tanaka", "Advance"] }),
    makeSupplementalCatalogEntry({ scientificName: "Sambucus nigra", group: "fruits", enCommonName: "Elderberry", viCommonName: "Co qua den", cultivars: ["Haschberg", "Black Lace", "York", "Nova", "Marge"] }),
    makeSupplementalCatalogEntry({ scientificName: "Corylus avellana", group: "fruits", enCommonName: "Hazelnut", viCommonName: "Phu phi", cultivars: ["Barcelona", "Jefferson", "Tonda di Giffoni", "Yamhill", "Ennis"] }),
    makeSupplementalCatalogEntry({ scientificName: "Juglans regia", group: "fruits", enCommonName: "English Walnut", viCommonName: "Oc cho", cultivars: ["Chandler", "Franquette", "Howard", "Lara", "Fernor"] }),
    makeSupplementalCatalogEntry({ scientificName: "Castanea sativa", group: "fruits", enCommonName: "Sweet Chestnut", viCommonName: "Hat de", cultivars: ["Marron de Lyon", "Bouche de Betizac", "Marigoule", "Precoce Migoule", "Colossal"] }),
    makeSupplementalCatalogEntry({ scientificName: "Olea europaea", group: "fruits", enCommonName: "Olive", viCommonName: "Oliu", cultivars: ["Arbequina", "Manzanilla", "Kalamata", "Frantoio", "Picual"] }),
    makeSupplementalCatalogEntry({ scientificName: "Ficus lyrata", group: "indoor", enCommonName: "Fiddle Leaf Fig", viCommonName: "Bang Singapore", cultivars: ["Bambino", "Compacta", "Columnar", "Little Fiddle", "Variegata"] }),
    makeSupplementalCatalogEntry({ scientificName: "Chamaedorea elegans", group: "indoor", enCommonName: "Parlor Palm", viCommonName: "Cau tieu tram", cultivars: ["Bella", "Neanthe Bella", "Compacta", "Elegans", "Pacaya"] }),
    makeSupplementalCatalogEntry({ scientificName: "Dypsis lutescens", group: "indoor", enCommonName: "Areca Palm", viCommonName: "Cau vang", cultivars: ["Golden Cane", "Butterfly", "Compacta", "Madagascar", "Golden Feather"] }),
    makeSupplementalCatalogEntry({ scientificName: "Howea forsteriana", group: "indoor", enCommonName: "Kentia Palm", viCommonName: "Cau kentia", cultivars: ["Forsteriana", "Sentry", "Paradise", "Norfolk", "Graceful"] }),
    makeSupplementalCatalogEntry({ scientificName: "Beaucarnea recurvata", group: "indoor", enCommonName: "Ponytail Palm", viCommonName: "Cay duoi ngua", cultivars: ["Recurvata", "Gold Star", "Dwarf", "Variegata", "Compacta"] }),
    makeSupplementalCatalogEntry({ scientificName: "Saintpaulia ionantha", group: "indoor", enCommonName: "African Violet", viCommonName: "Tu linh lan chau Phi", cultivars: ["Optimara", "Rob's Boolaroo", "Ma's Melody", "Little Maya", "Blue Dragon"] }),
    makeSupplementalCatalogEntry({ scientificName: "Schlumbergera truncata", group: "indoor", enCommonName: "Christmas Cactus", viCommonName: "Xuong rong Giang sinh", cultivars: ["Thanksgiving", "Christmas Flame", "Thor Carmen", "White Christmas", "Gold Charm"] }),
    makeSupplementalCatalogEntry({ scientificName: "Maranta leuconeura", group: "indoor", enCommonName: "Prayer Plant", viCommonName: "Cay cau nguyen", cultivars: ["Red Vein", "Kerchoveana", "Lemon Lime", "Fascinator", "Silver Band"] }),
    makeSupplementalCatalogEntry({ scientificName: "Codiaeum variegatum", group: "indoor", enCommonName: "Croton", viCommonName: "Cay co tong", cultivars: ["Petra", "Mammy", "Gold Dust", "Zanzibar", "Excellent"] }),
    makeSupplementalCatalogEntry({ scientificName: "Fatsia japonica", group: "indoor", enCommonName: "Japanese Aralia", viCommonName: "Thong thien nhat", cultivars: ["Spider's Web", "Camouflage", "Variegata", "Annelise", "Green Fingers"] }),
    makeSupplementalCatalogEntry({ scientificName: "Tulipa gesneriana", group: "flowers", enCommonName: "Tulip", viCommonName: "Uat kim huong", cultivars: ["Apeldoorn", "Queen of Night", "Angelique", "Negrita", "Ballerina"] }),
    makeSupplementalCatalogEntry({ scientificName: "Narcissus pseudonarcissus", group: "flowers", enCommonName: "Daffodil", viCommonName: "Thuy tien vang", cultivars: ["King Alfred", "Dutch Master", "Ice Follies", "Tete-a-Tete", "Carlton"] }),
    makeSupplementalCatalogEntry({ scientificName: "Dahlia pinnata", group: "flowers", enCommonName: "Dahlia", viCommonName: "Thược duoc", cultivars: ["Cafe au Lait", "Bishop of Llandaff", "Thomas Edison", "Kelvin Floodlight", "Arabian Night"] }),
    makeSupplementalCatalogEntry({ scientificName: "Iris germanica", group: "flowers", enCommonName: "Bearded Iris", viCommonName: "Dien vi rau", cultivars: ["Beverly Sills", "Immortality", "Superstition", "Hello Darkness", "Victoria Falls"] }),
    makeSupplementalCatalogEntry({ scientificName: "Paeonia lactiflora", group: "flowers", enCommonName: "Peony", viCommonName: "Mau don thao", cultivars: ["Sarah Bernhardt", "Festiva Maxima", "Karl Rosenfield", "Duchesse de Nemours", "Coral Charm"] }),
    makeSupplementalCatalogEntry({ scientificName: "Lilium candidum", group: "flowers", enCommonName: "Madonna Lily", viCommonName: "Hoa ly trang", cultivars: ["Candidum", "Album", "Apollo", "Cascade", "Snow Queen"] }),
    makeSupplementalCatalogEntry({ scientificName: "Zinnia elegans", group: "flowers", enCommonName: "Zinnia", viCommonName: "Cuc ngau", cultivars: ["Benary's Giant", "State Fair", "Queen Lime", "Profusion", "Zahara"] }),
    makeSupplementalCatalogEntry({ scientificName: "Cosmos bipinnatus", group: "flowers", enCommonName: "Cosmos", viCommonName: "Sao nhay", cultivars: ["Sensation", "Sonata", "Purity", "Rubenza", "Double Click"] }),
    makeSupplementalCatalogEntry({ scientificName: "Echinacea purpurea", group: "flowers", enCommonName: "Purple Coneflower", viCommonName: "Cuc mui tim", cultivars: ["Magnus", "PowWow Wild Berry", "White Swan", "Cheyenne Spirit", "Green Jewel"] }),
    makeSupplementalCatalogEntry({ scientificName: "Achillea millefolium", group: "flowers", enCommonName: "Yarrow", viCommonName: "Co thi", cultivars: ["Summer Pastels", "Paprika", "Moonshine", "Cerise Queen", "Colorado"] }),
    makeSupplementalCatalogEntry({ scientificName: "Delphinium elatum", group: "flowers", enCommonName: "Delphinium", viCommonName: "Phi yen thao", cultivars: ["Pacific Giant", "Magic Fountains", "Blue Bird", "Galahad", "Black Knight"] }),
    makeSupplementalCatalogEntry({ scientificName: "Primula vulgaris", group: "flowers", enCommonName: "Primrose", viCommonName: "Anh thao", cultivars: ["Danova", "Wanda", "Belarina", "Crescendo", "Husky"] }),
    makeSupplementalCatalogEntry({ scientificName: "Bellis perennis", group: "flowers", enCommonName: "English Daisy", viCommonName: "Cuc Anh", cultivars: ["Pomponette", "Tasso", "Habanera", "Galaxy", "Robella"] }),
    makeSupplementalCatalogEntry({ scientificName: "Calluna vulgaris", group: "flowers", enCommonName: "Heather", viCommonName: "Thach thao heather", cultivars: ["Dark Beauty", "Firefly", "Spring Torch", "Silver Knight", "Alicia"] }),
    makeSupplementalCatalogEntry({ scientificName: "Tropaeolum majus", group: "flowers", enCommonName: "Nasturtium", viCommonName: "Sen can", cultivars: ["Alaska", "Empress of India", "Jewel Mix", "Trailing Single", "Whirlybird"] }),
    makeSupplementalCatalogEntry({ scientificName: "Calendula officinalis", group: "flowers", enCommonName: "Calendula", viCommonName: "Cuc xu xi", cultivars: ["Pacific Beauty", "Resina", "Orange King", "Zeolights", "Snow Princess"] }),
    makeSupplementalCatalogEntry({ scientificName: "Leptospermum scoparium", group: "flowers", enCommonName: "Manuka", viCommonName: "Manuka", cultivars: ["Red Damask", "Snow White", "Wiri Joan", "Nanum Rubrum", "Kiwi"] }),
    makeSupplementalCatalogEntry({ scientificName: "Banksia integrifolia", group: "flowers", enCommonName: "Coast Banksia", viCommonName: "Banksia bien", cultivars: ["Sentinel", "Roller Coaster", "Coastal", "Austraflora", "Prostrate"] }),
    makeSupplementalCatalogEntry({ scientificName: "Eucalyptus gunnii", group: "flowers", enCommonName: "Cider Gum", viCommonName: "Bach dan cider", cultivars: ["Azura", "Silver Drop", "France Bleu", "Baby Blue", "Compacta"] }),
