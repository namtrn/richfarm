    ...
    handler: async (ctx) => {
        const plants = [
            ...
            // Herbs & spices
            {
                ...
                commonNames: [{ locale: "vi", name: "Hương thảo" }, { locale: "en", name: "Rosemary" }],
                group: "herbs",
                purposes: ["cooking_spices", "indoor"],
                description: "Hương thảo thơm mạnh, dùng nấu ăn và trang trí",
                typicalDaysToHarvest: 90,
                germinationDays: 14,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Húng tây" }, { locale: "en", name: "Thyme" }],
                group: "herbs",
                purposes: ["cooking_spices"],
                description: "Húng tây thơm nhẹ, hợp nhiều món Âu",
                typicalDaysToHarvest: 80,
                germinationDays: 10,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Kinh giới Tây" }, { locale: "en", name: "Oregano" }],
                group: "herbs",
                purposes: ["cooking_spices"],
                description: "Oregano dùng làm gia vị pizza, pasta",
                typicalDaysToHarvest: 80,
                germinationDays: 10,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Mùi tây" }, { locale: "en", name: "Parsley" }],
                group: "herbs",
                purposes: ["cooking_spices"],
                description: "Mùi tây thơm nhẹ, dễ trồng trong chậu",
                typicalDaysToHarvest: 70,
                germinationDays: 14,
                lightRequirements: "partial_shade",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Thì là" }, { locale: "en", name: "Dill" }],
                group: "herbs",
                purposes: ["cooking_spices"],
                description: "Thì là thơm đặc trưng, hợp món cá",
            ...
            // Leafy greens & brassicas
            {
                ...
                commonNames: [{ locale: "vi", name: "Bắp cải" }, { locale: "en", name: "Cabbage" }],
                group: "leafy_greens",
                purposes: ["cooking"],
                description: "Bắp cải dễ trồng, thu hoạch theo bắp",
                typicalDaysToHarvest: 90,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Bông cải xanh" }, { locale: "en", name: "Broccoli" }],
                group: "leafy_greens",
                purposes: ["cooking"],
                description: "Bông cải xanh giàu dinh dưỡng",
                typicalDaysToHarvest: 80,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Bông cải trắng" }, { locale: "en", name: "Cauliflower" }],
                group: "leafy_greens",
                purposes: ["cooking"],
                description: "Bông cải trắng mềm ngọt, dễ chế biến",
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cải bó xôi" }, { locale: "en", name: "Spinach" }],
                group: "leafy_greens",
                purposes: ["cooking", "salad"],
                description: "Cải bó xôi giàu sắt, mọc nhanh",
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cải thảo" }, { locale: "en", name: "Napa Cabbage" }],
                group: "leafy_greens",
                purposes: ["cooking"],
                description: "Cải thảo mềm, thích hợp nấu lẩu",
                typicalDaysToHarvest: 75,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            // Roots & nightshades
            {
                ...
                commonNames: [{ locale: "vi", name: "Củ dền" }, { locale: "en", name: "Beetroot" }],
                group: "roots",
                purposes: ["cooking"],
                description: "Củ dền đỏ, giàu dinh dưỡng",
                typicalDaysToHarvest: 70,
                germinationDays: 10,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cà tím" }, { locale: "en", name: "Eggplant" }],
                group: "nightshades",
                purposes: ["cooking"],
                description: "Cà tím dễ trồng, cho quả dài",
                typicalDaysToHarvest: 80,
                germinationDays: 10,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            // Legumes
            {
                ...
                commonNames: [{ locale: "vi", name: "Đậu que" }, { locale: "en", name: "Common Bean" }],
                group: "legumes",
                purposes: ["cooking"],
                description: "Đậu que giòn, thu hoạch nhanh",
                typicalDaysToHarvest: 55,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Đậu Hà Lan" }, { locale: "en", name: "Pea" }],
                group: "legumes",
                purposes: ["cooking"],
                description: "Đậu Hà Lan dễ trồng mùa mát",
                typicalDaysToHarvest: 60,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Đậu phộng" }, { locale: "en", name: "Peanut" }],
                group: "legumes",
                purposes: ["cooking"],
                description: "Đậu phộng (lạc) giàu protein",
            ...
            // Vegetables & fruits
            {
                ...
                commonNames: [{ locale: "vi", name: "Bí ngòi" }, { locale: "en", name: "Zucchini" }],
                group: "vegetables",
                purposes: ["cooking"],
                description: "Bí ngòi dễ trồng, cho quả nhanh",
                typicalDaysToHarvest: 55,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Bí đỏ" }, { locale: "en", name: "Squash" }],
                group: "vegetables",
                purposes: ["cooking"],
                description: "Bí đỏ ngọt, bảo quản được lâu",
                typicalDaysToHarvest: 90,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Dưa hấu" }, { locale: "en", name: "Watermelon" }],
                group: "fruits",
                purposes: ["cooking", "salad"],
                description: "Dưa hấu ngọt mát, cần nắng nhiều",
                typicalDaysToHarvest: 85,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Dưa lưới" }, { locale: "en", name: "Melon" }],
                group: "fruits",
                purposes: ["cooking", "salad"],
                description: "Dưa lưới thơm ngọt, cần chăm sóc tốt",
                typicalDaysToHarvest: 80,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Dâu tây" }, { locale: "en", name: "Strawberry" }],
                group: "fruits",
                purposes: ["salad", "dessert"],
                description: "Dâu tây chua ngọt, hợp khí hậu mát",
                typicalDaysToHarvest: 90,
                germinationDays: 14,
                lightRequirements: "partial_shade",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Chanh" }, { locale: "en", name: "Lemon" }],
                group: "fruits",
                purposes: ["cooking"],
                description: "Chanh dùng làm gia vị và nước uống",
                typicalDaysToHarvest: 180,
                germinationDays: 14,
                lightRequirements: "full_sun",
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cam" }, { locale: "en", name: "Orange" }],
                group: "fruits",
                purposes: ["cooking"],
                description: "Cam nhiều vitamin C, dễ chăm sóc",
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Đu đủ" }, { locale: "en", name: "Papaya" }],
                group: "fruits",
                purposes: ["cooking"],
                description: "Đu đủ dễ trồng vùng nhiệt đới",
            ...
            // Flowers
            {
                ...
                commonNames: [{ locale: "vi", name: "Dâm bụt" }, { locale: "en", name: "Hibiscus" }],
                group: "flowers",
                purposes: ["ornamental"],
                description: "Hoa dâm bụt nở đẹp, dễ chăm",
                typicalDaysToHarvest: 120,
                germinationDays: 14,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cúc vạn thọ" }, { locale: "en", name: "Marigold" }],
                group: "flowers",
                purposes: ["ornamental"],
                description: "Cúc vạn thọ dễ trồng, hoa bền màu",
                typicalDaysToHarvest: 70,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Hoa hồng" }, { locale: "en", name: "Rose" }],
                group: "flowers",
                purposes: ["ornamental"],
                description: "Hoa hồng thơm, có nhiều giống",
                typicalDaysToHarvest: 120,
                germinationDays: 14,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 3,
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Hoa hướng dương" }, { locale: "en", name: "Sunflower" }],
                group: "flowers",
                purposes: ["ornamental"],
                description: "Hoa hướng dương cần nắng nhiều",
                typicalDaysToHarvest: 80,
                germinationDays: 7,
                lightRequirements: "full_sun",
                wateringFrequencyDays: 2,
            ...
            // Indoor plants
            {
                ...
                commonNames: [{ locale: "vi", name: "Trầu bà" }, { locale: "en", name: "Pothos" }],
                group: "indoor",
                purposes: ["indoor", "air_purifying"],
                description: "Trầu bà dễ sống, lọc không khí",
                lightRequirements: "partial_shade",
                wateringFrequencyDays: 5,
                fertilizingFrequencyDays: 30,
                source: "cutting",
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Lưỡi hổ" }, { locale: "en", name: "Snake Plant" }],
                group: "indoor",
                purposes: ["indoor", "air_purifying"],
                description: "Lưỡi hổ chịu hạn tốt, dễ chăm",
            ...
            },
            {
                ...
                commonNames: [{ locale: "vi", name: "Cao su" }, { locale: "en", name: "Rubber Plant" }],
                group: "indoor",
                purposes: ["indoor", "air_purifying"],
                description: "Cao su cảnh lá to, hợp không gian trong nhà",
                lightRequirements: "partial_shade",
                wateringFrequencyDays: 7,
