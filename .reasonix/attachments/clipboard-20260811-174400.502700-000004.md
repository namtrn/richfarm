...
- managing adaptation terminology and at least five translations through the existing CMS dashboard;
...
- CMS workflows for managing terms, translations, and plant assignments.
...
6. Whether CMS editors may create adaptation terms or only edit approved terms and translations.
...
## 9. Phase 4: extend the CMS dashboard
...
```text
Release 1
Taxonomy, translations, CMS management, and plant assignments
        ↓
Release 2
...
| Five or more locales drift | Stable codes plus separately managed translations |
...
- CMS permissions for term creation and archival;
