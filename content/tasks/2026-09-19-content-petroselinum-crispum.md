# Content plan — Ngò tây / Parsley — 2026-09-19
...
- Display name: Ngò tây / Parsley
- Scientific name: Petroselinum crispum
- Content directory: content/plants/petroselinum-crispum
- Immutable plant_code: PETROSELINUM_CRISPUM_7F3H81CG9P
- Pair for the day: the other two plants scheduled on 2026-09-19 have their own plan files.
...
manifest and SQLite. Do not copy content from cilantro, celery or a different
Petroselinum taxon.
...
- Tách ngò tây lá phẳng và lá xoăn ở mức mô tả phù hợp, không gán đặc điểm cultivar khi manifest chỉ xác định loài.
- Làm rõ hạt nảy mầm chậm, nhu cầu giữ ẩm và lựa chọn chậu/nắng bán phần; không biến kinh nghiệm vùng này thành quy tắc toàn cầu.
- Nêu cách cắt tỉa để thu liên tục, dấu hiệu cây vươn ngồng và khác biệt của giai đoạn năm thứ hai nếu có nguồn.
- Đối chiếu sâu non bướm phượng, rệp và bệnh đốm lá với thư viện; chỉ dùng internal link cho stable key tồn tại.
...
- Revised content/plants/petroselinum-crispum/en.md.
- Revised content/plants/petroselinum-crispum/vi.md.
...
- The manifest targets PETROSELINUM_CRISPUM_7F3H81CG9P and the intended scientific name only.
