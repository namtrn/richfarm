# Content plan — Cà tím / Eggplant — 2026-09-20
...
- Display name: Cà tím / Eggplant
- Scientific name: Solanum melongena
- Content directory: content/plants/solanum-melongena
- Immutable plant_code: SOLANUM_MELONGENA_ZQR581DS56
...
- Xác minh nhu cầu nắng, nhiệt độ, chậu/luống và giá thể thoát nước của cây ưa ấm.
- Làm rõ giữ ẩm ổn định, nâng đỡ, ra hoa/đậu quả và cách thu hoạch theo dấu hiệu quả đạt độ già phù hợp.
- Tách hướng dẫn cho cây non, cây đang mang quả và giai đoạn cuối vụ; không áp một lịch mùa vụ cho cả Mỹ và Việt Nam.
- Đối chiếu sâu ăn lá, bọ hại quả và bệnh héo/đốm với nguồn đúng taxon và stable key hiện có.
...
- Revised content/plants/solanum-melongena/en.md.
- Revised content/plants/solanum-melongena/vi.md.
...
- The manifest targets SOLANUM_MELONGENA_ZQR581DS56 and the intended scientific name only.
