# Content plan — Cà chua / Tomato — 2026-09-14
...
- Display name: Cà chua / Tomato
- Scientific name: Solanum lycopersicum
- Content directory: content/plants/solanum-lycopersicum
- Immutable plant_code: SOLANUM_LYCOPERSICUM
- Pair for the day: the other plant scheduled on 2026-09-14 has its own plan file.
...
- Xác minh nhu cầu ánh sáng, chậu/luống, giá thể và tưới theo giai đoạn cây con, sinh trưởng, ra hoa và mang quả.
- Làm rõ cách làm giàn hoặc nâng đỡ, tỉa cành theo kiểu trồng; không biến một kỹ thuật thành quy tắc bắt buộc cho mọi giống.
- Đối chiếu các dấu hiệu rụng hoa, nứt quả, thiếu nước và bệnh/sâu thường gặp; chỉ liên kết các stable key đã có trong thư viện.
- Tách rõ hướng dẫn cho cây ăn quả và cảnh báo an toàn khi xử lý sâu bệnh.
...
- Revised content/plants/solanum-lycopersicum/en.md.
- Revised content/plants/solanum-lycopersicum/vi.md.
...
- The manifest targets SOLANUM_LYCOPERSICUM and the intended scientific name only.
