# Content plan — Húng quế / Basil — 2026-09-16
...
- Display name: Húng quế / Basil
- Scientific name: Ocimum basilicum
- Content directory: content/plants/ocimum-basilicum
- Immutable plant_code: OCIMUM_BASILICUM_8HN181CVDP
...
- Xác minh ánh sáng, chậu, thoát nước và cách tưới để tránh cây suy do úng hoặc khô kéo dài.
- Viết thao tác bấm ngọn, xử lý ngồng hoa và thu lá theo mục đích sử dụng; giải thích thời điểm thay vì chỉ ra mệnh lệnh.
- Đối chiếu gieo hạt/cành, thay chậu và bón phân nhẹ theo điều kiện trồng.
- Kiểm tra riêng sâu hại và bệnh lá; bản en/vi phải giữ cùng mức độ chắc chắn và cùng stable link targets.
...
- Revised content/plants/ocimum-basilicum/en.md.
- Revised content/plants/ocimum-basilicum/vi.md.
...
- The manifest targets OCIMUM_BASILICUM_8HN181CVDP and the intended scientific name only.
