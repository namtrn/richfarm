# Content plan — Ngò rí / Cilantro — 2026-09-16
...
- Display name: Ngò rí / Cilantro
- Scientific name: Coriandrum sativum
- Content directory: content/plants/coriandrum-sativum
- Immutable plant_code: CORIANDRUM_SATIVUM_CEGS81DMEG
- Pair for the day: the other plant scheduled on 2026-09-16 has its own plan file.
...
- Làm rõ ảnh hưởng của nhiệt độ và độ dài ngày đến việc nhanh ra hoa; viết mùa vụ theo vùng thay vì giả định một khí hậu chung.
- Mô tả gieo trực tiếp, tỉa cây, giữ ẩm cho cây con và gieo nối vụ.
- Tách mục thu lá khỏi mục giữ cây ra hạt; nêu cách quan sát khi cây bắt đầu già.
- Kiểm tra sâu hại/bệnh có bằng chứng cho đúng cây và tránh dùng nội dung của mùi tây hoặc rau gia vị khác.
...
- Revised content/plants/coriandrum-sativum/en.md.
- Revised content/plants/coriandrum-sativum/vi.md.
...
- The manifest targets CORIANDRUM_SATIVUM_CEGS81DMEG and the intended scientific name only.
