# Content plan — Hương thảo / Rosemary — 2026-09-20
...
- Display name: Hương thảo / Rosemary
- Scientific name: Rosmarinus officinalis
- Content directory: content/plants/rosmarinus-officinalis
- Immutable plant_code: ROSMARINUS_OFFICINALIS_JY3D81CNVF
- Pair for the day: the other two plants scheduled on 2026-09-20 have their own plan files.
...
manifest and SQLite. The manifest uses Rosmarinus officinalis; do not silently
replace the target identity with a different naming convention.
...
- Đối chiếu tên khoa học hiện có trong manifest với tên được chấp nhận trong nguồn, nhưng giữ nguyên plant_code và không tự đổi danh tính dữ liệu.
- Ưu tiên nắng đầy đủ, thông thoáng, đất thoát nước nhanh và chu kỳ khô giữa các lần tưới; giải thích dấu hiệu úng thay vì đưa lịch tưới cứng.
- Nêu khác biệt chăm trong chậu, trú đông theo khí hậu và cắt tỉa/giâm cành khi có nguồn hỗ trợ.
- Đối chiếu nhện đỏ, thối rễ và bệnh trên tán với thư viện; chỉ liên kết stable key đã kiểm tra, không suy diễn từ cây gia vị khác.
...
- Revised content/plants/rosmarinus-officinalis/en.md.
- Revised content/plants/rosmarinus-officinalis/vi.md.
...
- The manifest targets ROSMARINUS_OFFICINALIS_JY3D81CNVF and the intended scientific name only.
