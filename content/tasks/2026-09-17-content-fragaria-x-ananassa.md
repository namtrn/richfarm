# Content plan — Dâu tây / Strawberry — 2026-09-17
...
- Display name: Dâu tây / Strawberry
- Scientific name: Fragaria × ananassa
- Content directory: content/plants/fragaria-x-ananassa
- Immutable plant_code: FRAGARIA_X_ANANASSA_74T181D475
- Pair for the day: the other plant scheduled on 2026-09-17 has its own plan file.
...
- Xác minh vị trí nắng, độ thoát nước và độ cao của crown khi trồng chậu hoặc luống.
- Tách chăm sóc cây đang ra hoa/đậu quả khỏi quản lý ngó; giải thích khi nào giữ ngó và khi nào ưu tiên quả.
- Nêu tưới, dinh dưỡng, phủ bề mặt và thu hái theo dấu hiệu quả chín; tránh lịch cứng không phù hợp vùng trồng.
- Kiểm tra bệnh quả/lá và sâu hại thường gặp, liên kết đúng stable key và giữ hướng dẫn xử lý an toàn ở mức đầu tiên.
...
- Revised content/plants/fragaria-x-ananassa/en.md.
- Revised content/plants/fragaria-x-ananassa/vi.md.
...
- The manifest targets FRAGARIA_X_ANANASSA_74T181D475 and the intended scientific name only.
