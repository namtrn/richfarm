# Content plan — Trầu bà / Pothos — 2026-09-19
...
- Display name: Trầu bà / Pothos
- Scientific name: Epipremnum aureum
- Content directory: content/plants/epipremnum-aureum
- Immutable plant_code: EPIPREMNUM_AUREUM_KVQ181DD4Y
...
- Làm rõ giới hạn ánh sáng: cây chịu được ánh sáng thấp không đồng nghĩa với không cần ánh sáng.
- Mô tả tưới theo độ khô của giá thể, dấu hiệu úng rễ và cách kiểm tra trước khi tưới.
- Đối chiếu leo/rủ, giá đỡ, cắt tỉa và nhân giống bằng cành; tách nhu cầu của cây trong chậu khỏi mục đích trang trí.
- Kiểm tra sâu hại/bệnh có bằng chứng, cùng cảnh báo an toàn cần thiết nếu được nguồn xác minh; không thêm mẹo truyền miệng.
...
- Revised content/plants/epipremnum-aureum/en.md.
- Revised content/plants/epipremnum-aureum/vi.md.
...
- The manifest targets EPIPREMNUM_AUREUM_KVQ181DD4Y and the intended scientific name only.
