# Content plan — Dưa leo / Cucumber — 2026-09-15
...
- Display name: Dưa leo / Cucumber
- Scientific name: Cucumis sativus
- Content directory: content/plants/cucumis-sativus
- Immutable plant_code: CUCUMIS_SATIVUS_T8Y981CMBN
...
- Xác minh cách bố trí giàn, khoảng không và thông thoáng; phân biệt trồng đất với trồng chậu.
- Viết chuỗi quan sát đất/lá → diễn giải thiếu nước, úng hoặc sốc nhiệt → hành động điều chỉnh.
- Làm rõ thu hoạch thường xuyên, giai đoạn cây và cách gieo lứa mới; tránh áp một lịch mùa vụ cho cả Mỹ và Việt Nam.
- Kiểm tra riêng nhóm sâu hại và bệnh, đặc biệt các vấn đề liên quan đến lá và độ ẩm; chỉ dùng link key đã tồn tại.
...
- Revised content/plants/cucumis-sativus/en.md.
- Revised content/plants/cucumis-sativus/vi.md.
...
- The manifest targets CUCUMIS_SATIVUS_T8Y981CMBN and the intended scientific name only.
