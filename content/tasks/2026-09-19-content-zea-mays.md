# Content plan — Bắp ngọt / Sweet corn — 2026-09-19
...
- Display name: Bắp ngọt / Sweet corn
- Scientific name: Zea mays convar. saccharata
- Content directory: content/plants/zea-mays
- Immutable plant_code: ZEA_MAYS_CONVAR_SACCHARATA_GRJD82H1V0
- Pair for the day: the other plants scheduled on 2026-09-19 have their own plan files.
...
- Xác minh cơ chế thụ phấn nhờ gió bắt buộc phải trồng theo khối/ô vuông thay vì hàng đơn lẻ.
- Nhu cầu nước cực kỳ khắt khe trong hai giai đoạn sống còn: trổ cờ và phun râu bắp vào hạt.
- Vun gốc tạo điều kiện rễ chân kiềng chống đổ ngã; thu hoạch đúng độ chín sữa vào sáng sớm.
- Đối chiếu sâu ăn lá/đục bắp, rệp mềm, bệnh gỉ sắt (rust), đốm lá và thối rễ.
...
- Revised content/plants/zea-mays/en.md.
- Revised content/plants/zea-mays/vi.md.
...
- The manifest targets ZEA_MAYS_CONVAR_SACCHARATA_GRJD82H1V0 and the intended scientific name only.
