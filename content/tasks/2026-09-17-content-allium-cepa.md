# Content plan — Hành tây / Onion — 2026-09-17
...
- Display name: Hành tây / Onion
- Scientific name: Allium cepa
- Content directory: content/plants/allium-cepa
- Immutable plant_code: ALLIUM_CEPA_Q5KS82ENRE
- Pair for the day: the other two plants scheduled on 2026-09-17 have their own plan files.
...
manifest and SQLite. Do not copy content from green onion, shallot or a
different Allium taxon.
...
- Phân biệt hành tây lấy củ với hành lá, hành tím và các Allium khác; nêu đúng mục đích sử dụng của cây trong manifest.
- Giải thích vai trò của độ dài ngày và giống trong việc hình thành củ, đồng thời chuyển thành hướng dẫn chọn thời điểm theo vùng thay vì lịch chung.
- Làm rõ bộ rễ nông, nhu cầu tưới đều, dấu hiệu củ trưởng thành và các bước làm khô/bảo quản sau thu hoạch nếu có nguồn.
- Đối chiếu bọ trĩ, ruồi hại hành và bệnh sương mai với thư viện; không gộp sâu hại vào nhóm bệnh.
...
- Revised content/plants/allium-cepa/en.md.
- Revised content/plants/allium-cepa/vi.md.
...
- The manifest targets ALLIUM_CEPA_Q5KS82ENRE and the intended scientific name only.
