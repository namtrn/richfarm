# Content plan — Bạc hà / Mint — 2026-09-17
...
- Display name: Bạc hà / Mint
- Scientific name: Mentha × piperita
- Content directory: content/plants/mentha-x-piperita
- Immutable plant_code: MENTHA_X_PIPERITA_XJ6N81DMC4
...
- Xác minh đúng taxon đích là Mentha × piperita, không trộn nội dung của các loài Mentha khác.
- Tập trung vào trồng chậu, kiểm soát thân/rễ lan rộng, giá thể ẩm nhưng thoát nước và vị trí có ánh sáng phù hợp.
- Mô tả cắt ngọn, thu hái và nhân giống bằng cành; không đưa một con số thời gian nếu không có nguồn.
- Đối chiếu thối rễ, gỉ sắt và sâu hại với thư viện; chỉ thêm mục khi có bằng chứng và stable key.
...
- Revised content/plants/mentha-x-piperita/en.md.
- Revised content/plants/mentha-x-piperita/vi.md.
...
- The manifest targets MENTHA_X_PIPERITA_XJ6N81DMC4 and the intended scientific name only.
