# Content plan — Cần tây / Celery — 2026-09-19
...
- Display name: Cần tây / Celery
- Scientific name: Apium graveolens
- Content directory: content/plants/apium-graveolens
- Immutable plant_code: APIUM_GRAVEOLENS_X2Y182FMDV
...
- Xác minh nguồn gốc đầm lầy dẫn đến đòi hỏi giữ ẩm đất liên tục, không bao giờ được để đất khô kiệt.
- Tính nhạy cảm với nhiệt độ cao gây xơ cứng cuống lá, tăng vị cay đắng và kích thích ngồng hoa sớm.
- Kỹ thuật gieo hạt nhỏ nảy mầm chậm, bón thúc hữu cơ định kỳ và kỹ thuật bọc gốc tẩy trắng cuống.
- Đối chiếu rệp mềm, bọ trĩ kẽ lá, sâu ăn lá, bệnh đốm lá (leaf spot) và thối rễ.
...
- Revised content/plants/apium-graveolens/en.md.
- Revised content/plants/apium-graveolens/vi.md.
...
- The manifest targets APIUM_GRAVEOLENS_X2Y182FMDV and the intended scientific name only.
