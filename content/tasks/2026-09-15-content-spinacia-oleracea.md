# Content plan — Rau bina / Spinach — 2026-09-15
...
- Display name: Rau bina / Spinach
- Scientific name: Spinacia oleracea
- Content directory: content/plants/spinacia-oleracea
- Immutable plant_code: SPINACIA_OLERACEA_QKMN81DXBC
...
- Xác minh tính mẫn cảm cao với nhiệt độ ấm nóng và ngày dài dẫn đến hiện tượng ngồng hoa sớm (bolting).
- Đặc điểm rễ ăn nông đòi hỏi giữ ẩm liên tục nhưng tuyệt đối không được đọng nước gây thối cổ rễ.
- Nhu cầu đất màu mỡ, pH trung tính (6.5-7.0), độ nhạy cảm với đất chua (pH < 6.0) gây vàng lá còi cọc.
- Liên kết chính xác với sâu ăn lá, ốc sên, rệp mềm, bệnh sương mai (downy mildew) và thối rễ.
...
- Revised content/plants/spinacia-oleracea/en.md.
- Revised content/plants/spinacia-oleracea/vi.md.
...
- The manifest targets SPINACIA_OLERACEA_QKMN81DXBC and the intended scientific name only.
