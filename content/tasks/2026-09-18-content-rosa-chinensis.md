# Content plan — Hoa hồng / Rose — 2026-09-18
...
- Display name: Hoa hồng / Rose
- Scientific name: Rosa chinensis
- Content directory: content/plants/rosa-chinensis
- Immutable plant_code: ROSA_CHINENSIS_E2WH81DYRD
- Pair for the day: the other plant scheduled on 2026-09-18 has its own plan file.
...
- Xác minh nhu cầu nắng, thông thoáng, chậu/luống và tưới sâu; phân biệt cây mới trồng với bụi đã ổn định.
- Viết cắt tỉa, bón phân và chăm sóc sau đợt hoa theo mục đích, không coi mọi kiểu cắt là bắt buộc.
- Đối chiếu dấu hiệu đốm lá, phấn trắng, rệp/nhện hoặc sâu khác bằng nguồn đúng taxon; tách sâu hại khỏi bệnh.
- Giữ cảnh báo an toàn khi xử lý gai và chế phẩm, nhưng không đưa khuyến cáo hóa chất thiếu căn cứ.
...
- Revised content/plants/rosa-chinensis/en.md.
- Revised content/plants/rosa-chinensis/vi.md.
...
- The manifest targets ROSA_CHINENSIS_E2WH81DYRD and the intended scientific name only.
