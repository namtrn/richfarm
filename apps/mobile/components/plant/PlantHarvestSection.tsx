        ...
        <>
            <View style={{ backgroundColor: theme.card, borderRadius: 12, padding: 20, borderWidth: 1, borderColor: theme.border, shadowColor: '#1a1a18', shadowOpacity: 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 2 } }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                    ...
                    >
                        <Text style={{ color: '#fff', fontSize: 12, fontWeight: '500' }}>{t('plant.harvest_add')}</Text>
                    </TouchableOpacity>
                </View>
                {localLoading ? (
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', gap: 12 }}>
                        <View style={{ flex: 1, gap: 8 }}>
                            <Text style={{ fontSize: 12, fontWeight: '500', color: theme.textSecondary, textTransform: 'uppercase', letterSpacing: 0.3 }}>{t('plant.harvest_quantity_label')}</Text>
                            <TextInput
                        ...
                        <View style={{ flex: 1, gap: 8 }}>
                            <Text style={{ fontSize: 12, fontWeight: '500', color: theme.textSecondary, textTransform: 'uppercase', letterSpacing: 0.3 }}>{t('plant.harvest_unit_label')}</Text>
                            <TextInput
                                value={harvestUnit}
