...
struct Provider: TimelineProvider {
    ...
    private func loadWidgetData() -> PlantWidgetEntry {
        ...
        log("loadWidgetData plantCount=\(entry.plantCount) nextWatering=\(entry.nextWatering) nextWateringPlant=\(entry.nextWateringPlant) hasOverdue=\(entry.hasOverdue)")
        return entry
    }
}
